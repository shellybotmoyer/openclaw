...
describe("formatCliCommand", () => {
	...
	it("trims whitespace from profile", () => {
		expect(
			formatCliCommand("openclaw doctor --fix", { OPENCLAW_PROFILE: "  jbopenclaw  " }),
	...
	it("handles bun run wrapper", () => {
		expect(formatCliCommand("bun run openclaw doctor", { OPENCLAW_PROFILE: "work" })).toBe(
			"bun run openclaw --profile work doctor",
		);
	});
});
