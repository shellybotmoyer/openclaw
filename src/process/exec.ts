 ...
 * On Windows, non-.exe commands (like npm, bun) require their .cmd extension.
 */
function resolveCommand(command: string): string {
	...
	// Common Node package manager commands that need .cmd extension on Windows.
	const cmdCommands = ["npm", "bun", "yarn", "npx", "bunx"];
