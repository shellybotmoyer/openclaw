...
async function resolveCliEntrypointPathForService(): Promise<string> {
	...
	if (looksLikeDist) {
		...
		// since package-manager symlinks under node_modules are automatically updated,
		// while the resolved path contains
	...
	throw new Error(
		`Cannot find built CLI at ${distCandidates.join(" or ")}. Run "bun run build" first, or use dev mode.`,
	);
}
